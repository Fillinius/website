...
export const metadata: Metadata = {
  ...
  description:
    'Профессиональное строительство ангаров любого типа. От проектирования, до сдачи готового здания.  СтройГрад — ваш партнер в строительстве. Гарантия  до 5 лет.',
  keywords: [
    'Стройград',
    'ГК Стройград',
    'Строй град',
    'ГК Строй Град',
    'Стройград Нижний Новгород',
    'ГК Стройград Нижний Новгород',
    'промышленные полы',
    'топинговые полы',
    'полимерные полы',
  ],
